...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../frontend/css/pages/authentication.css">
    <!-- END: Page CSS-->
                    ...
                    <div class="card bg-authentication rounded-0 mb-0">
                        <div class="row m-0">
                            <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                <img src="../../../frontend/images/pages/login.png" alt="branding logo">
                            </div>
                                        ...
                                        <div class="card-body pt-1">
                                            <form method="POST" action="{{ route('login') }}">
                                                ...
                                                <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                    <input type="text"  id="email" placeholder="E-mail" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus>
