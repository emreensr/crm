                            ...
                            <ul class="nav nav-tabs mb-3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                        <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">Tekrarlı Görev</span>
                                    </a>
                                </li>
                            </ul>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table nowrap scroll-horizontal-vertical">
                                                            ...
                                                            <tr>
                                                                <th>Görev No</th>
                                                                <th>Oluşturan</th>
                                                                <th>Tekrarlama Tipi</th>
                                                                <th>Tekrarlama Başlangıç Tarih</th>
                                                                <th>Tekrarlama Bitiş Tarih</th>
                                                                <th>Açıklama</th>
                                                                <th>Geçerli</th>
                                                            </tr>
                                                            </thead>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="date" class="form-control" name="office"  data-validation-required-message="This mobile number is required">
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control" name="office"  data-validation-required-message="This mobile number is required">
                                                                </td>
