                            ...
                            <ul class="nav nav-tabs mb-3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                        <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">Öneri Değerlendirme</span>
                                    </a>
                                </li>
                            </ul>
                                                ...
                                                <div class="card-body card-dashboard">
                                                    <div class="table-responsive">
                                                        <table class="table nowrap scroll-horizontal-vertical">
                                                            ...
                                                            <tr>
                                                                <th>Öneri Tarihi</th>
                                                                <th>Öneri Yapan Personel</th>
                                                                <th>Şube Adı</th>
                                                                <th>Öneri Adı</th>
                                                                <th>Öneri Türü</th>
                                                                <th>Öneri Alanları</th>
                                                                <th>Değerlendirme Tipi</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            <tr>
