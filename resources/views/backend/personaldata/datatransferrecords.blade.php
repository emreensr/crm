                            ...
                            <ul class="nav nav-tabs mb-3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                        <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">Veri Aktarım Kayıtları</span>
                                    </a>
                                </li>
                            </ul>
                                                ...
                                                <div class="card-body card-dashboard">
                                                    <div class="table-responsive">
                                                        <table class="table nowrap scroll-horizontal-vertical">
                                                            <thead>
                                                            <tr>
                                                                <th>Sorumlu Şirket</th>
                                                                <th>Veri Kategorisi</th>
                                                                <th>Veri Konusu Kişi Grubu</th>
                                                                <th>Aktarım Tarihi</th>
                                                                <th>Aktarıldığı Kurum</th>
                                                                <th>Aktarım Gerekçesi</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            <tr>
