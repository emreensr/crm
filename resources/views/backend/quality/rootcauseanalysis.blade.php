                            ...
                            <ul class="nav nav-tabs mb-3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                        <i class="feather icon-user mr-25"></i><span class="d-none d-sm-block">Kök Neden Analizi</span>
                                    </a>
                                </li>
                            </ul>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table nowrap scroll-horizontal-vertical">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>Tarih</th>
                                                                <th>Toplantı Yeri</th>
                                                                <th>Uygunsuzluk Kaynağı</th>
                                                                <th>İlişkili Düzeltici Faaliyeti</th>
                                                                <th>İlişkili Risk</th>
                                                                <th>Problem Tanımı</th>
                                                                <th>Tespit Edilen Kök Neden</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            <tr>
