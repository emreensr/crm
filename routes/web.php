...
Route::get('product_add', 'ProductController@add_product')->name('product_add');
Route::post('product_insert', 'ProductController@insert')->name('product_insert');
Route::get('product_list', 'ProductController@index')->name('product_list');

Route::get('product_view/{id}', 'ProductController@product_view')->name('product_view');

Route::get('product_edit/{id}', 'ProductController@product_edit')->name('product_edit');
Route::post('product_editpost/{id}', 'ProductController@product_editpost')->name('product_editpost');
